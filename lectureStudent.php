        ...
        <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a href="" class="nav-link active" >Student Details</a></li>
            ...
            <table class='tbl1'>
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $query="select st_id,fname,lname,age,DOB,gender,address,email,contact_no,dep_id from student where st_id in(select st_id from stusub where sub_id in (select sub_id from subject where lec_id='$username'))";
                ...
                <tbody>
                    ...
                    if(isset($_POST['send'])){
                        ...
                        if($stid!=""){
                            ...
                            echo "<script>window.location.assign('lectureStudent.php');</script>";
                            mysqli_query($connection,$queryinsertsub);
                            echo "<script>alert('Private Message Sent')</script>";
                                
                            }
                        }else{
                            echo"<script>alert('Please Enter the Reciver ID')</script>";
                            return false;
                        }    
                    ...
                    if(isset($_POST['sendpub'])){
                        ...
                        $time=date("H:i:s");
                            ...
                            echo "<script>window.location.assign('lectureStudent.php');</script>";
                            mysqli_query($connection,$queryinsertsub);
                            echo "<script>alert('Public Message Sent')</script>";
